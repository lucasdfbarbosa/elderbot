...
var jogo = {
  ...
  canc: [
...

    {
      ...
      perd: [
        { ativo: false, nmo: false }, // indicador da Perdição
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725313417478184/Cthulhu.jpeg',
    },

    {
      ...
      bat: [
        { d: 0 }, // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<  igual ao número de Monstros no jogo <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        { d: 'C' },
        { d: 'T' },
      ],
      // poder:
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725454119338024/Hastur.jpeg',
    },

    {
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725556813201426/Ithaqua.jpeg',
    },

    {
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725690753712168/Nyarlathotep.jpeg',
    },

    {
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725801840377866/Shub-Niggurath.jpeg',
    },

    {
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725890113437696/Yig.jpeg',
    },

    {
      ...
      destr: false,
      imag:
        'https://media.discordapp.net/attachments/785724975520415787/785725989787140106/Yog-Sothoth.jpeg',
    },
  ],
  ...
  cavnt: [
    ...
    {
      nome: 'Arrombamento na Madrugada',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    {
      nome: 'Assombrado por uma Figura Sombria',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    {
      nome: 'Baile de Gala no Salão Principal',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    ...
    {
      nome: 'Lagoa de Carpas Ornamentais',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    ...
    {
      nome: 'O Gabinete de Armazenamento',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    ...
    {
      nome: "Tempestade em Copo D'Água",
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
    ...
    {
      nome: 'Você se Transforma Naquilo que Mais Teme',
      tipo: 'avent',
      disp: true,
      nobar: true,
    },
  ...
  com: [
    {
      nome: 'As Terras Oníricas',
      tipo: 'omund',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792380732513058816/792380915086786570/As_Terras_Oniricas.jpeg?width=385&height=655',
    },
    {
      nome: 'Cidade da Grande Raça',
      tipo: 'omund',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792380974595964948/792381097987407912/Cidade_da_Grande_Raca.jpeg?width=389&height=655',
    },
    {
      nome: 'Grande Salão de Celeno',
      tipo: 'omund',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792399514903379998/792399579966472252/Grande_Salao_de_Celeno.jpeg?width=389&height=655',
    },
    {
      nome: 'O Abismo',
      tipo: 'omund',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792399638795386880/792399693844840448/O_Abismo.jpeg?width=389&height=655',
    },
    {
      nome: 'Outra Dimensão',
      tipo: 'omund',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792399734122741810/792399784849833984/Outra_Dimensao.jpeg?width=384&height=655',
    },
    {
      nome: 'Planalto de Leng',
      tipo: 'omund',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792399825529602099/792399914079617074/Planalto_de_Leng.jpeg?width=379&height=655',
    },
    {
      nome: "R'lyeh",
      tipo: 'omund',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792400039108280340/792400130321940491/Rlyeh.jpeg?width=386&height=655',
    },
    {
      nome: 'Yuggoth',
      tipo: 'omund',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792400189418897418/792400284768141332/Yuggoth.jpeg?width=386&height=655',
    },
  ],
  ...
  cmito: [
    {
      nome: 'A Loucura Toma Conta... Para Trazer Horrores',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793971900883402764/793972330443440138/A_Loucura_Toma_Conta_Para_Trazer_Horrores.jpeg?width=424&height=654',
    },
    {
      nome: 'Aparelhos Esotéricos... Revelam uma Pista Falsa',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793972531999670322/793972602552975420/Aparelhos_Esotericos_Revelam_uma_Pista_Falsa.jpeg?width=420&height=655',
    },
    {
      nome: 'As Artes Arcanas... Fecham as Portas',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793972825287294996/793972880030695424/As_Artes_Arcanas_Fecham_as_Portas.jpeg?width=423&height=654',
    },
    {
      nome: 'As Estrelas se Alinham... Acima das Nuvens Negras',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793973049363529728/793973124269473843/As_Estrelas_se_Alinham_Acima_das_Nuvens_Negras.jpeg?width=422&height=654',
    },
    {
      nome: 'As Estrelas se Alinham... Antes de a Razão Perecer',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793973248999030854/793973326858813450/As_Estrelas_se_Alinham_Antes_de_a_Razao_Perecer.jpeg?width=421&height=654',
    },
    {
      nome: 'As Estrelas se Alinham... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793974029237092362/793974085784043590/As_Estrelas_se_Alinham_Em_Meio_a_Calmaria.jpeg?width=424&height=655',
    },
    {
      nome: 'As Estrelas se Alinham... Em Meio à Calmaria',
      tipo: 'mito',
    ...
    {
      nome: 'As Estrelas se Alinham... Para Trazer Horrores',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793974166457942117/793974221373440020/As_Estrelas_se_Alinham_Para_Trazer_Horrores.jpeg?width=425&height=655',
    },
    {
      nome: 'As Estrelas se Alinham... Sobre uma Porta Aberta',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793974525536632882/793974591231492116/As_Estrelas_se_Alinham_Sobre_uma_Porta_Aberta.jpeg?width=427&height=655',
    },
    {
      nome: 'As Ferramentas Certas... Criam uma Fenda',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793974653810507837/793974801663655937/As_Ferramentas_Certas_Criam_uma_Fenda.jpeg?width=423&height=655',
    },
    {
      nome: 'Bens Pessoais... Trazem Boa Sorte',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793974870877667409/793974933306736640/Bens_Pessoais_Trazem_Boa_Sorte.jpeg?width=425&height=655',
    },
    {
      nome: 'Conhecimento Tétrico... Numa Mente Perturbada',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793976888669241375/793976948745043988/Conhecimento_Tetrico_Numa_Mente_Perturbada.jpeg?width=427&height=654',
    },
    {
      nome: 'Entidades Sombrias... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977000460419112/793977060821303426/Entidades_Sombrias_Em_Meio_a_Calmaria.jpeg?width=422&height=655',
    },
    {
      nome: 'Esteja Preparado... Para Pesadelos Reais',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977120040419348/793977184392970260/Esteja_Preparado_Para_Pesadelos_Reais.jpeg?width=422&height=655',
    },
    {
      nome: 'Fraqueza Exposta... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977360738156554/793977429369552976/Fraqueza_Exposta_Em_Meio_a_Calmaria.jpeg?width=423&height=655',
    },
    {
      nome: 'Mantenha os Amigos Próximos... Quando as Memórias Desvanecerem',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977485397721118/793977570046902332/Mantenha_os_Amigos_Proximos_Quando_as_Memorias_Desvanecerem.jpeg?width=425&height=654',
    },
    {
      nome: 'Monstros Horríveis... Revelam um Segredo',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977711567044621/793977771566694440/Monstros_Horriveis_Revelam_um_Segredo.jpeg?width=417&height=655',
    },
    {
      nome: 'Terror Repentino... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977842765529148/793977894744752169/Terror_Repentino_Em_Meio_a_Calmaria.jpeg?width=423&height=654',
    },
    {
      nome: 'Um Aviso... De Pesadelos Reais',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793977959961853954/793978015860260904/Um_Aviso_De_Pesadelos_Reais.jpeg?width=426&height=654',
    },
    {
      nome: 'Um Aviso... De uma Conspiração',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793978064324919308/793978128539582464/Um_Aviso_De_uma_Conspiracao.jpeg?width=424&height=655',
    },
    {
      nome: 'Um Aviso... De uma Maldição',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793978201935577088/793978275768565800/Um_Aviso_De_uma_Maldicao.jpeg?width=426&height=655',
    },
    {
      nome: 'Um Aviso... De uma Prisão Obscura',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793978327891312670/793978436321411072/Um_Aviso_De_uma_Prisao_Obscura.jpeg?width=429&height=655',
    },
    {
      nome: 'Um Caminho Tortuoso... Para Trazer Horrores',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793978515951321148/793978564688609330/Um_Caminho_Tortuoso_Para_Trazer_Horrores.jpeg?width=427&height=655',
    },
    {
      nome: 'Um Fardo Pesado... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793978730821320744/793978781466886235/Um_Fardo_Pesado_Em_Meio_a_Calmaria.jpeg?width=423&height=655',
    },
    {
      nome: 'Um Preço Alto Demais... Para Trazer Horrores',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793984737546731540/793984789422145606/Um_Preco_Alto_Demais_Para_Trazer_Horrores.jpeg?width=430&height=655',
    },
    {
      nome: 'Visões Estranhas... Antes da Tempestade',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793984851500859413/793984918463578142/Visoes_Estranhas_Antes_da_Tempestade.jpeg?width=422&height=655',
    },
    {
      nome: 'Visões Estranhas... De uma Armadilha Venenosa',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793984999732805685/793985048583471104/Visoes_Estranhas_De_uma_Armadilha_Venenosa.jpeg?width=424&height=655',
    },
    {
      nome: 'Visões Estranhas... Em Meio à Calmaria',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793985217785233409/793985287553548328/Visoes_Estranhas_Em_Meio_a_Calmaria.jpeg?width=425&height=655',
    },
    {
      nome: 'Visões Estranhas... Em Meio à Calmaria',
      tipo: 'mito',
    ...
    {
      nome: 'Visões Estranhas... Nas Sombras à Espreita',
      tipo: 'mito',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/793985348194664508/793985451949424700/Visoes_Estranhas_nas_Sombras_a_Espreita.jpeg?width=423&height=655',
    },
  ],
  ...
  ccom: [
    {
      nome: 'Cigarreira da Sorte', // nome do item
      id: 'cig', // id do item
      ...
      nobar: true, // está no baralho?
      imag:
        'https://media.discordapp.net/attachments/792431832171937792/792431879525630002/Cigarreira_da_Sorte.jpeg?width=426&height=655',
    }, // link da imagem do item
    {
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432321323991100/792432391456817152/Comida.jpeg?width=419&height=655',
    },
    {
      nome: 'Diário Antigo',
      id: 'dia',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432425350856735/792432478551146506/Diario_Antigo.jpeg?width=430&height=655',
    },
    {
      nome: 'Dinamite',
      id: 'din',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432516509466674/792432583006093332/Dinamite.jpeg?width=431&height=655',
    },
    {
      nome: 'Espingarda',
      id: 'esg',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432620758630451/792432668360310794/Espingarda.jpeg?width=423&height=655',
    },
    {
      nome: 'Faca',
      id: 'fac',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432700421963796/792432743945338930/Faca.jpeg?width=424&height=654',
    },
    {
      nome: 'Lanterna',
      id: 'lan',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432773922553897/792432825222692924/Lanterna.jpeg?width=427&height=654',
    },
    {
      nome: 'Machado',
      id: 'mac',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792432856156602388/792432940649807882/Machado.jpeg?width=432&height=655',
    },
    {
      nome: 'Pistola Automática .45',
      id: 'pis',
      tipo: 'comum',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792433018416529414/792433094568575036/Pistola_Automatica_45.jpeg?width=429&height=655',
    },
    {
      nome: 'Revólver .38',
      id: 'rev',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792433134603206668/792433194292084736/Revolver_38.jpeg?width=431&height=655',
    },
    {
      nome: 'Tommy Gun',
      id: 'tom',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792433213016113182/792433264412590120/Tommy_Gun.jpeg?width=431&height=654',
    },
    {
      nome: 'Uísque',
      id: 'uis',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792433329386291231/792433371396571187/Uisque.jpeg?width=434&height=655',
    },
  ],
  ...
  cesp: [
    {
      ...
      invst: '-',
      disp: true,
      nobar: true, // ver descrição dos campos em ITENS COMUNS
      imag:
        'https://media.discordapp.net/attachments/792434831932784680/792434887365230602/Cultes_des_Goules.jpeg?width=427&height=654',
    },
    {
      nome: 'Cultos Inomináveis',
      id: 'col',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792434916218241024/792434981338742785/Cultos_Inominaveis.jpeg?width=430&height=655',
    },
    {
      nome: 'Espada de Glória',
      id: 'esp',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435012305813584/792435051999789116/Espada_de_Gloria.jpeg?width=428&height=655',
    },
    {
      nome: 'Estátua Alienígena',
      id: 'est',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435081880403968/792435124577763358/Estatua_Alienigena.jpeg?width=427&height=655',
    },
    {
      nome: 'Flauta dos Deuses Exteriores',
      id: 'fla',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435171181854750/792435229846405130/Flauta_dos_Deuses_Exteriores.jpeg?width=423&height=655',
    },
    {
      nome: 'Lâmpada de Alhazred',
      id: 'lam',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435270837469215/792435318682419200/Lampada_de_Alhazred.jpeg?width=428&height=655',
    },
    {
      nome: 'Livro de Dzyan',
      id: 'liv',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435358729371678/792435403243651122/Livro_de_Dzyan.jpeg?width=430&height=654',
    },
    {
      nome: 'Necronomicon',
      id: 'nec',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435425867595806/792435493765775360/Necronomicon.jpeg?width=426&height=655',
    },
    {
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435524241195088/792435560265416714/O_Rei_de_Amarelo.jpeg?width=423&height=655',
    },
    {
      nome: 'Pedra de Cura',
      id: 'ped',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435614032199710/792435658521706546/Pedra_de_Cura.jpeg?width=428&height=655',
    },
    {
      nome: "Rubi de R'lyeh",
      id: 'rub',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792482014983880714/792482086887358465/Rubi_de_Rlyeh.jpeg?width=405&height=619',
    },
    {
      nome: 'Vigia Azul da Pirâmide',
      id: 'vig',
      tipo: 'especial',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792435681690910810/792435722476716062/Vigia_Azul_da_Piramide.jpeg?width=426&height=655',
    },
  ],
  ...
  cfeit: [
    {
      ...
      nobar: true, // ver descrição dos campos em ITENS COMUNS
      imag:
        'https://media.discordapp.net/attachments/792408150589571081/792408252264218634/Aprisionar_Monstro.jpeg?width=427&height=655',
    },
    {
      nome: 'Bloquear Memória',
      id: 'blo',
      tipo: 'feitiço',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408359181484032/792408408547655700/Bloquear_Memoria.jpeg?width=427&height=654',
    },
    {
      nome: 'Cura',
      id: 'cur',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408549698437150/792408592228941885/Cura.jpeg?width=426&height=655',
    },
    {
      nome: 'Encantar Arma',
      id: 'ena',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408622830190604/792408663339958282/Encantar_Arma.jpeg?width=429&height=654',
    },
    {
      nome: 'Encontrar Portal',
      id: 'eno',
      tipo: 'feitiço',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408697695371264/792408752598417438/Encontrar_Portal.jpeg?width=424&height=655',
    },
    {
      nome: 'Maldição Terrível de Azathoth',
      tipo: 'feitiço',
      id: 'mal',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408781283000344/792408822320201778/Maldicao_Terrivel_de_Azathoth.jpeg?width=427&height=655',
    },
    {
      nome: 'Névoas de Releh',
      id: 'nev',
      tipo: 'feitiço',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792408925671784488/792409017325977630/Nevoas_de_Releh.jpeg?width=432&height=655',
    },
    {
      nome: 'Perda de Vigor',
      id: 'per',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792409141587083274/792409190378897408/Perda_de_Vigor.jpeg?width=427&height=655',
    },
    {
      nome: 'Proteção da Pele',
      id: 'pro',
      tipo: 'feitiço',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792409339407237160/792409397874786304/Protecao_da_Pele.jpeg?width=423&height=655',
    },
    {
      nome: 'Secagem',
      id: 'sec',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792409813837152316/792409857860829205/Secagem.jpeg?width=421&height=655',
    },
    {
      nome: "Símbolo Vermelho de Shudde M'ell",
      id: 'sim',
      tipo: 'feitiço',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792409929856188447/792409994171252756/Simbolo_Vermelho_de_Shudde_Mell.jpeg?width=426&height=655',
    },
    {
      nome: 'Voz de Rá',
      id: 'voz',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792410075116994609/792410116531814410/Voz_de_Ra.jpeg?width=427&height=654',
    },
  ],
  ...
  caliado: [
    {
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792450979730554920/792451021049561158/Anna_Kaslow.jpeg?width=406&height=618',
    }, // ver descrição dos campos em ITENS COMUNS
    {
      nome: 'Duke',
      id: 'duk',
      tipo: 'aliado',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451042830843965/792451119200075786/Duke.jpeg?width=411&height=618',
    },
    {
      nome: 'Eric Colt',
      id: 'eri',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451135771246622/792451173844123648/Eric_Colt.jpeg?width=405&height=618',
    },
    {
      nome: 'Professor Armitage',
      id: 'arm',
      tipo: 'aliado',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451193984122920/792451230835408926/Professor_Armitage.jpeg?width=407&height=618',
    },
    {
      nome: 'Richard Upton Pickman',
      id: 'ric',
      tipo: 'aliado',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451252356120586/792451288817991690/Richard_Upton_Pickman.jpeg?width=408&height=618',
    },
    {
      nome: 'Ruby Standish',
      id: 'sta',
      ...
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451309097713666/792451354333413436/Ruby_Standish.jpeg?width=407&height=618',
    },
    {
      nome: 'Thomas F. Malone',
      id: 'tho',
      tipo: 'aliado',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451382321872897/792451446367846420/Thomas_F_Malone.jpeg?width=405&height=618',
    },
    {
      nome: 'Tom "Montanha" Murphy',
      id: 'mur',
      tipo: 'aliado',
      invst: '-',
      disp: true,
      nobar: true,
      imag:
        'https://media.discordapp.net/attachments/792451498877386752/792451560881782824/Tom_Montanha_Murphy.jpeg?width=405&height=618',
    },
  ],
...
client.on('message', function (message: any) {
  ...
  // ######## ########  !oi    -   teste "oi"  ######## ########
  if (command === 'oi') {
    message.reply(`oi você! :sunglasses:`)
  }
    ...
    if (
      ...
      result.addFields(
        { name: '\u200B', value: '\u200B' },
        {
          ...
          value:
            '**' +
            mesa[imatv].cinvs[x].sanid.atual +
            '**  <:sanidade:785894917398200321>',
          inline: true,
        },
        {
          name: 'Resistência',
          value:
            '**' +
            mesa[imatv].cinvs[x].resist.atual +
            '**  <:resistencia:785894901837070406>',
          inline: true,
        },
        { name: '\u200B', value: '\u200B' },
        {
        ...
        for (i = 0; i < mesa[imatv].cinvs[x].trof.length; i++) {
          ...
          switch (mesa[imatv].cinvs[x].trof[i].tipo) {
            case 'avent':
              t +=
                '• **' +
                mesa[imatv].cinvs[x].trof[i].valor +
                '** ' +
                mesa[imatv].cavnt[y].nome +
                ' *(aventura)*\n'
              break
            case 'omund':
              t +=
            ...
            case 'monst':
              t +=
                ...
                mesa[imatv].cinvs[x].trof[i].valor +
                '** ' +
                mesa[imatv].cmonst[y].nome +
                ' *(monstro)*\n'
              break
          }
        }
        result.addField('Troféus', t)
      }
    ...
    if (
      ...
      if (mesa[imatv].cinvs[x].itens.length > 0) {
        for (i = 0; i < mesa[imatv].cinvs[x].itens.length; i++) {
          result.setColor('#fffdd0')
          result.setAuthor(
            mesa[imatv].cinvs[x].nome + ' possui',
            mesa[imatv].cinvs[x].aimag,
            mesa[imatv].cinvs[x].murl,
          )
          switch (mesa[imatv].cinvs[x].itens[i].item) {
            ...
            case 'tom':
            case 'uis':
              var y = mesa[imatv].ccom.findIndex(
                (y) => y.id === mesa[imatv].cinvs[x].itens[i].item,
              )
              result.setTitle(mesa[imatv].ccom[y].nome)
              result.setDescription('*' + mesa[imatv].ccom[y].tipo + '*')
              result.setThumbnail(
                'https://cdn.discordapp.com/emojis/786001424529883147.png?v=1',
              )
              result.setImage(mesa[imatv].ccom[y].imag)
              break
            case 'cel':
            case 'col':
            case 'esp':
            ...
            case 'rly':
            case 'vig':
              var y = mesa[imatv].cesp.findIndex(
                (y) => y.id === mesa[imatv].cinvs[x].itens[i].item,
              )
              result.setTitle(mesa[imatv].cesp[y].nome)
              result.setDescription('*' + mesa[imatv].cesp[y].tipo + '*')
              result.setThumbnail(
                'https://cdn.discordapp.com/emojis/786001446129631243.png?v=1',
              )
              result.setImage(mesa[imatv].cesp[y].imag)
              break
            case 'apr':
            case 'blo':
            case 'cur':
            ...
            case 'sim':
            case 'voz':
              var y = mesa[imatv].cfeit.findIndex(
                (y) => y.id === mesa[imatv].cinvs[x].itens[i].item,
              )
              result.setTitle(mesa[imatv].cfeit[y].nome)
              result.setDescription('*' + mesa[imatv].cfeit[y].tipo + '*')
              result.setThumbnail(
                'https://cdn.discordapp.com/emojis/786001402475708486.png?v=1',
              )
            ...
            case 'tho':
            case 'mur':
              var y = mesa[imatv].caliado.findIndex(
                (y) => y.id === mesa[imatv].cinvs[x].itens[i].item,
              )
              result.setTitle(mesa[imatv].caliado[y].nome)
              result.setDescription('*' + mesa[imatv].caliado[y].tipo + '*')
              result.setThumbnail(
                'https://cdn.discordapp.com/emojis/786001382796034079.png?v=1',
              )
        ...
        message.reply(
          mesa[imatv].cinvs[x].nome + ' não possui itens no momento',
        )
      }
    }
  }
  ...
  if (command === 'encerrar') {
    if (
      ...
      message.reply(
        'MODO DE JOGO não selecionado\nDigite o comando `!modo -op` para selecionar um modo esta MESA',
      )
    } else {
      if (!mesa[imatv].atv) {
        message.reply('esta MESA não possui jogo ativo')
      } else {
  ...
  if (
    ...
    switch (command) {
      ...
      case 'yig':
      case 'yog':
        const xAnc = jogo.canc.findIndex((xAnc) => xAnc.id == command)
        result.setColor('#8c000f')
        result.setTitle(jogo.canc[xAnc].nome)
        result.setDescription('*' + jogo.canc[xAnc].desc + '*')
        result.setImage(jogo.canc[xAnc].imag)
        break
      case 'ama':
      case 'bob':
      case 'car':
      ...
      case 'pet':
      case 'vin':
        const xInv = jogo.cinvs.findIndex((xInv) => xInv.id == command)
        result.setColor('#fffdd0')
        result.setTitle(jogo.cinvs[xInv].nome)
        result.setDescription('*' + jogo.cinvs[xInv].desc + '*')
        result.setImage(jogo.cinvs[xInv].imag)
        break
    }
    message.channel.send(result)
  }
  ...
  const solicitacaoMesa = '790943019758649374'
  const topSecretMesa = '785827646344265779'
  if (command === 'mesa') {
    if (
      message.channel.id != solicitacaoMesa &&
      message.channel.id != topSecretMesa
    )
      message.reply(
        'por favor, faça a solicitação de mesa em <#785827646344265779>',
      )
    else {
      var nome_mesa = 'Mesa'
      ...
      message.guild.channels
        ...
        .then((cat) => {
          message.guild.channels.create('jogo', {
            // create new channel in new category
            type: 'voice',
            parent: cat,
          })
          ...
          message.guild.channels
            ...
            .then((channel) => {
              channel.send(
                '<@' + message.author.id + '>, prepare aqui sua mesa',
              )
              channel.send(
  ...
  if (command == 'modo') {
    if (
      ...
      message.reply(
        'você digitou um comando com um argumento inválido.\nDigite o comando novamente.',
      )
    } else {
  ...
  if (command == 'modojogo') {
    if (
      ...
      const msg = `essa é a Mesa #${imatv + 1} no modo`
      switch (mesa[imatv].modo) {
        case 'simples':
          message.reply(msg + '``` PARTIDA SIMPLES ```')
          break
        case 'sobr':
          message.reply(msg + '``` SOBREVIVÊNCIA ```')
          break
        case 'solo':
          message.reply(msg + '``` JOGO SOLO ```')
          break
        case 'custom':
          message.reply(msg + '``` PARTIDA CUSTOMIZADA ```')
          break
        default:
  ...
  if (command === 'an') {
    if (
      ...
      for (i = 0; i < 8; i++) {
        mesa[imatv].canc[i].nobar = true
      } // volta todas as cartas para o baralho (para permitir nova seleção de anciões sem que entre em loop)
      var argsvale = true
      if (args.length > 1) {
        for (i = 0; i < args.length; i++) {
          if (
            ...
            (parseInt(args[0]) < 1 || parseInt(args[0]) > 8)
          ) {
            // valida argumentos
            argsvale = false
            break
        ...
        if (!argsvale) {
          message.reply(
            'você digitou um comando com argumentos inválidos.\nDigite comando novamente.',
          )
        } else {
          if (
            args.length == 2 &&
            ...
            // se comando for !an N r ; para N = [1..8]
        ...
        //desta linha pra baixo args.length <= 1
        if (mesa[imatv].modo == 'sobr') {
          ...
          if (
            ...
            argsvale = false // valida argumentos
          } else {
            if (args[0] == 'r') {
              do {
                var roll = Math.floor(Math.random() * 8)
      ...
      if (!argsvale) {
        ...
        var iaam = mesa[imatv].canc.findIndex(
          (iaam) => iaam.id === mesa[imatv].ancord[posaam],
        ) // index do anciao ativo da mesa
        ...
        if (mesa[imatv].ancord.length == 1) {
          ...
          var anctxt = '``` Ordem dos Anciões:\n '
        }
        for (i = 0; i < mesa[imatv].ancord.length; i++) {
          var x = mesa[imatv].canc.findIndex(
            (x) => x.id === mesa[imatv].ancord[i],
          )
          if (i == mesa[imatv].ancord.length - 1) {
            ...
            var anctxt =
              ...
              (i + 1) +
              '. ' +
              mesa[imatv].canc[x].nome +
              '		<--- ativo\n '
          } else {
            var anctxt =
              anctxt + (i + 1) + '. ' + mesa[imatv].canc[x].nome + '\n '
          }
        }
        anctxt = anctxt + '```'
        result.setColor('#8c000f')
  ...
  if (command === 'in') {
    if (
      ...
      if (args.length > 1) {
        for (i = 0; i < args.length; i++) {
          if (
            ...
            (parseInt(args[0]) < 1 || parseInt(args[0]) > 16)
          ) {
            // valida argumentos
            argsvale = false
            break
        ...
        if (!argsvale) {
          ...
          if (
            ...
            // se comando for !an N r ; para N = [1..8/16]
            var N = parseInt(args[0])
            if (mesa[imatv].modo != 'custom' && N > 8) {
              if (mesa[imatv].modo == 'simples') {
                var msgmd = '**MODO SIMPLES**'
              } else {
                var msgmd = '**MODO SOBREVIVÊNCIA**'
              }
              message.reply(
        ...
        if (
          ...
          if (mesa[imatv].modo == 'solo') {
            if (args[0] == 'r') {
              ...
              var iiam = mesa[imatv].cinvs.findIndex(
                (iiam) => iiam.id === args[0],
              )
              if (args[0] == 'pet') {
                mesa[imatv].cinvs[roll].itens.push({ item: 'duk' })
      ...
      for (i = 0; i < mesa[imatv].invord.length; i++) {
        var x = mesa[imatv].cinvs.findIndex(
          (x) => x.id === mesa[imatv].invord[i],
        )
    ...
    if (
        ...
        .then((channel) => {
          ...
          switch (mesa[imatv].modo) {
            ...
            case 'custom':
              ...
              break
            default:
              b = 'Verifique MODO DE JOGO com o comando `!modojogo`'
          }
          if (mesa[imatv].invord.length > 1) {
            if (mesa[imatv].devord.length > 0) {
              if (mesa[imatv].devord.length == 1) {
                b +=
                  'Investigadores ativos: ' +
                  (mesa[imatv].invord.length + 1) +
                  '         Investigador devorado:\n'
                for (i = 0; i < mesa[imatv].invord.length; i++) {
                  x = mesa[imatv].cinvs.findIndex(
                    (x) => x.id === mesa[imatv].invord[i],
                  )
                  if (i == 0) {
                    y = mesa[imatv].cinvs.findIndex(
                      (y) => y.id === mesa[imatv].devord[0],
                    )
                    b +=
                      ' • ' +
                      mesa[imatv].cinvs[x].nome +
                      '          • ' +
                      mesa[imatv].cinvs[y].nome +
                      '\n'
                  } else {
                ...
                if (mesa[imatv].invord.length < mesa[imatv].devord.length) {
                  for (
                    i = mesa[imatv].invord.length;
                    i < mesa[imatv].devord.length;
                    i++
                  ) {
                    y = mesa[imatv].cinvs.findIndex(
                      (y) => y.id === mesa[imatv].devord[i],
            ...
            if (mesa[imatv].devord.length > 0) {
              if (mesa[imatv].devord.length == 1) {
                b +=
                  'Investigador ativo:                     Investigador devorado:\n'
                x = mesa[imatv].cinvs.findIndex(
                  (x) => x.id === mesa[imatv].invord[0],
                )
                y = mesa[imatv].cinvs.findIndex(
                  (y) => y.id === mesa[imatv].devord[0],
                )
                ...
                b +=
                  'Investigador ativo:          Investigadores devorados: ' +
                  (mesa[imatv].devord.length + 1) +
                  '\n'
                x = mesa[imatv].cinvs.findIndex(
                  (x) => x.id === mesa[imatv].invord[0],
          ...
          switch (mesa[imatv].modo) {
            case 'simples':
              b += '\nAncião ativo:\n'
              let x = mesa[imatv].canc.findIndex(
                (x) => x.id === mesa[imatv].ancord[0],
              )
      ...
      message.guild.channels
        .create('jogo', {
          type: 'text',
          topic:
            'Canal destinado a discutir estratégias da partida. As rolagens de dados e passagem do tempo com resolução das cartas Mito também serão neste canal.',
          parent: message.channel.parentID,
        })
        .then((channel) => {
  ...
  if (command === 'r') {
    if (
      ...
      if (message.channel.name != 'preparação') {
        ...
        if (!((args[0] - 1) * (args[0] - 6) <= 0)) {
          message.reply(
            '\no primeiro argumento (`N`) do comando `!r N v a m` deve ser a quantidade *(entre 1 e 6)* de **DADOS VERDES** a ser rolada.',
          )
        } else {
          if (args[0] > mesa[imatv].maxv) {
            args[0] = mesa[imatv].maxv
            message.reply(
              `você digitou uma quantidade maior que o limite de ${mesa[imatv].maxv} dados verdes. Foi rolado a quantidade máxima.`,
            )
          }
          ...
          for (var i = 1; i < args.length; i++) {
            ...
            switch (arg) {
              case 'v':
                if (v == 1) {
                  ...
                  for (var j = 0; j < parseInt(args[0]); j++) {
                    // roll green dice args[0] times (max maxv.value)
                    ...
                    switch (roll) {
                      ...
                      case 1:
                        ...
                        break
                      case 2:
                        r += ' <:3v:786453361355784202> '
                        break
                      case 3:
                        r += ' <:cv:786453375977914398> '
                        break
                      case 4:
                        r += ' <:pv:786453432998953011> '
                        break
                      case 5:
                        r += ' <:tv:786453449592012832> '
                        break
                    }
                  }
                }
              ...
              case 'a': // roll yellow die
                if (a == 1) {
                  message.reply(
                    `você tentou rolar o dado amarelo mais de uma vez. Porém, foi rolado apenas uma única vez.`,
                  )
                } else {
                  a = 1
                  var roll = Math.floor(Math.random() * 6) // This JavaScript function always returns a random number between min and max (both included) -- Math.floor(Math.random() * (max - min + 1) ) + min;
                  switch (roll) {
                    case 0:
                      r += ' <:1a:786456678840401930> '
                      break
                    case 1:
                      r += ' <:2a:786456689909825616> '
                      break
                    case 2:
                      r += ' <:3a:786456715133714462> '
                      break
                    case 3:
                      r += ' <:4a:786457589763670048> '
                      break
                    case 4:
                      r += ' <:ca:786456745089695754> '
                      break
                    case 5:
                      r += ' <:pa:786456850022400061> '
                      break
                  }
                }
                break
              ...
              case 'm': // roll red die
                if (m == 1) {
                  message.reply(
                    `você tentou rolar o dado vermelho mais de uma vez. Porém, foi rolado apenas uma única vez.`,
                  )
                } else {
                  m = 1
                  var roll = Math.floor(Math.random() * 6) // This JavaScript function always returns a random number between min and max (both included) -- Math.floor(Math.random() * (max - min + 1) ) + min;
                  switch (roll) {
                    case 0:
                      r += ' <:2m:786456701129719808> '
                      break
                    case 1:
                      r += ' <:3m:786458650964656158> '
                      break
                    case 2:
                      r += ' <:4m:786456730393247784> '
                      break
                    case 3:
                      r += ' <:cm:786456756087291964> '
                      break
                    case 4:
                      r += ' <:pm:786457764569677844> '
                      break
                    case 5:
                      r += ' <:crm:786456766904926208> '
                      break
                  }
                }
                break
              default:
                message.reply(
                  'Não há rolagem para o argumento `' + arg + '` digitado',
                )
            }
          }
          message.reply(`${r}`)
  ...
  if (command === 'av') {
    if (
      ...
      if (mesa[imatv].maxavnt < 1) {
        message.channel.send(
          '*O baralho de **Aventuras** `[inserir emoji da aventura]` foi reembaralhado*',
        )
        for (i = 0; i < mesa[imatv].cavnt.length; i++) {
          mesa[imatv].cavnt[i].nobar = true
        }
        mesa[imatv].maxavnt = 48
      }
      if (mesa[imatv].maxavnt < 0)
        message.channel.send(
          '<@392823505869340682>, o contador de cartas está NEGATIVO! Verifica issaê.',
        ) // <<<<<<< isso NUNCA é pra acontecer
      do {
        var roll = Math.floor(Math.random() * 48) // This JavaScript function always returns a random number between min and max (both included) -- Math.floor(Math.random() * (max - min + 1) ) + min;
  ...
  if (command === 'om') {
    if (
      ...
      if (mesa[imatv].maxom < 1) {
        message.channel.send(
          '*O baralho de **Outro Mundo** `[inserir emoji de outro mundo ~~oloko~~]` foi reembaralhado*',
        )
        for (i = 0; i < mesa[imatv].com.length; i++) {
          mesa[imatv].com[i].nobar = true
        }
        mesa[imatv].maxom = 32
      }
      if (mesa[imatv].maxom < 0)
        message.channel.send(
          '<@392823505869340682>, o contador de cartas está NEGATIVO! Verifica issaê.',
        ) // <<<<<<< isso NUNCA é pra acontecer
      do {
        var roll = Math.floor(Math.random() * 32) // This JavaScript function always returns a random number between min and max (both included) -- Math.floor(Math.random() * (max - min + 1) ) + min;
  ...
  if (command === 'c') {
    if (
      ...
      if (mesa[imatv].maxcom > 0) {
        if (mesa[imatv].maxcom < 0)
          message.channel.send(
            ':warning:   <@392823505869340682>, o contador de cartas está NEGATIVO! Verifica issaê.   :warning:',
          ) // só pra mencionar a mim se e qndo isto ficar negativo, coisa que NÃO É pra acontecer
        if (reemb == 1)
          message.channel.send(
            `*O baralho de **ITENS COMUNS**  <:item_com:786001424529883147> estava vazio e foi reembaralhado com ${mesa[imatv].maxcom}/12 cartas*`,
          )
        do {
        ...
        result.setAuthor(
          mesa[imatv].cinvs[x].nome + ' encontrou',
          mesa[imatv].cinvs[x].aimag,
        )
  ...
  if (command === 'mito') {
    if (
      ...
      if (mesa[imatv].maxmito < 1) {
        message.channel.send(
          '*O baralho de **Cartas do Mito** <:mito:787335941827330049> foi reembaralhado*',
        )
        for (i = 0; i < mesa[imatv].cmito.length; i++)
          mesa[imatv].cmito[i].nobar = true
        mesa[imatv].maxmito = 32
      }
      if (mesa[imatv].maxmito < 0)
        message.channel.send(
          '<@392823505869340682>, o contador de cartas está NEGATIVO! Verifica issaê.',
        )
      do {
      ...
      result.setThumbnail(
        'https://cdn.discordapp.com/emojis/787335941827330049.png?v=1',
      )
  ...
  if (command === 'usar') {
    if (
      ...
      if (
        ...
        if (args[1] === 'p' && mesa[imatv].cinvs[x].pista <= 0) {
          // investigador tenta usar pista sem possuir
          if (mesa[imatv].cinvs[x].pista < 0)
            message.channel.send(
              '<@392823505869340682>, o contador de pistas está NEGATIVO! Verifica issaê.',
            ) // só pra mencionar a mim se e qndo isto ficar negativo, coisa que NÃO É pra acontecer
          ...
          result.setImage(
            'https://discord.com/assets/289673858e06dfa2e0e3a7ee610c3a30.svg',
          )
        }

        if (args[1] === 'p' && mesa[imatv].cinvs[x].pista > 0) {
          // investigador usa pista
          mesa[imatv].cinvs[x].pista--
          result.setAuthor(
            mesa[imatv].cinvs[x].nome +
        ...
        if (
          ...
          if (mesa[imatv].ccom[y].invst != mesa[imatv].cinvs[x].id) {
            result.setColor('ffcc00')
            result.setAuthor(
              mesa[imatv].cinvs[x].nome + ' não possui este item',
              mesa[imatv].cinvs[x].aimag,
            )
        ...
        if (
          ...
          result.setImage(mesa[imatv].cesp[x].imag)
        }
        ...
        if (
          ['ann', 'duk', 'eri', 'arm', 'ric', 'sta', 'tho', 'mur'].includes(
            args[1],
          )
        ) {
